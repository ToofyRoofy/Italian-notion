const GRAMMAR = [
    ...
    "blocks": [
      {
        ...
        "examples": [
          ...
          {
            "it": "Chiunque (أي حد / أياً كان) — للعاقل فقط، والفعل بعدها دايماً مفرد",
      ...
      },
      {
        ...
        "rows": [
          [
            ...
            "Questa penna non scrive, ne voglio un'altra — القلم ده لا يكتب، عايز قلمًا غيره"
          ],
          [
        ...
        "examples": [
          {
            ...
            "ar": "Non sa ancora dove andare — لسه مش عارف يروح فين"
          },
          {
  ...
  },
  {
    ...
    "blocks": [
      {
        "type": "note",
        "ar": "Anche و Pure كلاهما معناهم 'أيضًا / أيضاً' وممكن نستخدمهم بدل بعض في أغلب الكلام العادي، وبيتحطوا عادةً قبل الكلمة التي تريدين نأكد عليها مباشرة."
      },
      {
        "type": "item",
        "it": "Anche (أيضًا / أيضاً) — أكتر استخدام وحيادية",
        "ar": "",
        "examples": [
          {
            "it": "Anche Marco viene alla festa",
            "ar": "ماركو أيضًا جاي الحفلة"
          },
          {
            "it": "Vengo anch'io",
            "ar": "أنا أيضًا جاي (anche+io = بتتدمج وتصبح anch'io)"
          },
          {
            "it": "Ho anche fame",
            "ar": "أنا أيضًا جعان"
      ...
      {
        "type": "item",
        "it": "Pure (أيضًا / أيضاً) — نفس المعنى، ولها استخدام عادة كتعبير عن الإذن/التشجيع",
        "ar": "",
        "examples": [
          {
            "it": "Pure io voglio venire",
            "ar": "أنا أيضًا عايز أجي"
          },
          {
            "it": "Puoi pure restare",
            "ar": "تقدر أيضًا تفضل هنا (بمعنى: خليك، لا توجد ليسكلة)"
          },
          {
            "it": "Vai pure!",
            "ar": "يلا اتفضل / روح على راحتك! (تعبير عن السماح)"
          }
        ]
      },
      {
        "type": "note",
        "ar": "💡 ملحوظة: anche وpure بيتحطوا قبل الكلمة التي تريدين نأكد عليها: 'Anche tu hai ragione' (أنت أيضًا معاك حق) غير 'Hai ragione anche tu' (لسه أنت معاك حق برضو) — المعنى قريب لكن مكان الكلمة بيغيّر التوكيد."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "blocks": [
      ...
      {
        "type": "note",
        "ar": "في الإيطالي عادةً بنشيل الضمير لأن تصريف الفعل بنفسه يدل على الفاعل (Ho mangiato = أكلت، ليس لازم أقول Io ho mangiato). لكن بنستخدم الضمير في حالتين: للتوكيد أو المقارنة (Io sì, ma lui no)، أو لو التصريف نفسه ممكن يلتبس مثل Lui/Lei في بعض الأزمنة."
      },
      {
        "type": "item",
        "it": "أمثلة",
  ...
  },
  {
    ...
    "blocks": [
      {
        "type": "note",
        "ar": "ظرف الحال يصف طريقة أداء الفعل (حصل إزاي؟)، وشكله ثابت ليس بيتأثر بجنس ولا عدد ولا زمن. بيتكوّن غالباً بإضافة mente لآخر الصفة."
      },
      {
        "type": "item",
        "it": "أمثلة",
      ...
      {
        "type": "note",
        "ar": "💡 في الكلام العامي كثيرًا بيستخدموا الصفة نفسها كظرف بدل الصيغة الرسمية: Fai veloce! (أنجز/أسرع!) بدل Fai velocemente. وفي صيغ المقارنة: più velocemente di... (بسرعة أكتر من...)، والتفضيل: il più velocemente possibile (بأسرع ما يمكن)."
      }
    ]
  },
  {
    ...
    "blocks": [
      {
        ...
        "rows": [
          ...
          [
            "Sempre",
            "دائماً",
            "Ho sempre detto la verità — كنت باقول الحقيقة دايماً"
          ],
          [
            "Più (+Non)",
  ...
  },
  {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "note": "1) بمعنى نصف: لو جت قبل اسم بتتبعه في الجنس والعدد (Un mezzo chilo = نصف كيلو، Una mezza ora = نص ساعة). 2) بمعنى وسيلة: مثل mezzi di trasporto (وسائل المواصلات). 3) بمعنى المنتصف: مثل nel mezzo (في النص).",
        "examples": [
          {
            "it": "Un mezzo chilo",
            "ar": "نصف كيلو"
  ...
  },
  {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "it": "Diverso",
        "ar": "مختلف / متنوع / آخر",
        "note": "من المجموعة التي بتنتهي بـ o، فتتغير حسب الجنس والعدد. لو جت قبل الاسم في صيغة الجمع بتاخد معنى 'عدة/عديد من' بدل 'مختلف'",
        "examples": [
          {
            "it": "Un modo diverso",
            "ar": "طريقة مختلفة"
