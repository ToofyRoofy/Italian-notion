...
const WORDS = [
  ...
  {it:"libro",    ar:"كتبويب",               ipa:"/ˈliː.bro/",     pron:"لي-برو",        cat:"أشياء",      ex:"Leggo un libro ogni giorno."},
  {it:"porta",    ar:"باب",                ipa:"/ˈpɔr.ta/",      pron:"بور-تا",        cat:"أشياء",      ex:"La porta è aperta."},
  {it:"sole",     ar:"شمس",                ipa:"/ˈsoː.le/",      pron:"سو-لماذا",        cat:"طبيعة",      ex:"Il sole splende forte."},
  ...
  {it:"buono",    ar:"جيد / طيب",         ipa:"/ˈbwɔː.no/",     pron:"بووو-نو",       cat:"صفات",       ex:"Questo caffè è molto buono."},
  ...
  {it:"scusa",    ar:"آسف / عذرًا",         ipa:"/ˈskuː.za/",     pron:"سكو-زا",        cat:"تعبيرات",    ex:"Scusa, non ho capito."},
  {it:"ciao",     ar:"مرحبا / مع السلامة", ipa:"/tʃaʊ/",         pron:"تشاو",          cat:"تعبيرات",    ex:"Ciao! Come stai oggi?"},
  {it:"amore",    ar:"حب",                 ipa:"/aˈmoː.re/",     pron:"أ-مو-ريه",      cat:"ليساعر",      ex:"L'amore è la cosa più bella."},
  ...
  {it:"musica",   ar:"موسيقى",             ipa:"/ˈmuː.zi.ka/",   pron:"مو-مثل-كا",      cat:"فن",         ex:"Ascolto la musica ogni sera."},
  ...
  {it:"voi",   ar:"أنتم", ipa:"/ˈvɔi/",    pron:"فويّ",    cat:"ضمائر", ex:"Voi siete pronti per l'esame?"},
  {it:"loro",  ar:"هم",   ipa:"/ˈlɔː.ro/", pron:"لو-رو",   cat:"ضمائر", ex:"Loro escono spesso la sera."},

  // أيام الأسبوع
  {it:"lunedì",    ar:"الإتنين", ipa:"/luneˈdi/",    pron:"لونيه-هذه",    cat:"أيام الأسبوع", ex:"Lunedì inizio un nuovo corso."},
  {it:"martedì",   ar:"التلات",  ipa:"/marteˈdi/",   pron:"مارتيه-هذه",   cat:"أيام الأسبوع", ex:"Martedì ho lezione di italiano."},
  {it:"mercoledì", ar:"الأربع",  ipa:"/merkoleˈdi/", pron:"ميركولماذا-هذه", cat:"أيام الأسبوع", ex:"Mercoledì vado in palestra."},
  {it:"giovedì",   ar:"الخميس",  ipa:"/dʒoveˈdi/",   pron:"جوفيه-هذه",    cat:"أيام الأسبوع", ex:"Giovedì ho un esame difficile."},
  {it:"venerdì",   ar:"الجمعة",  ipa:"/venerˈdi/",   pron:"فينير-هذه",    cat:"أيام الأسبوع", ex:"Venerdì usciamo con gli amici."},
  ...
  // أدوات ربط وأسئلة
  {it:"perché",     ar:"لماذا / لأن",      ipa:"/perˈke/",             pron:"بير-كيه",        cat:"أدوات ربط", ex:"Perché non hai risposto?"},
  {it:"mentre",     ar:"بينما",          ipa:"/ˈmen.tre/",           pron:"مَن-تريه",       cat:"أدوات ربط", ex:"Mentre studio, ascolto musica."},
  {it:"quindi",     ar:"يعني / إذن",     ipa:"/ˈkwin.di/",           pron:"كوين-هذه",        cat:"أدوات ربط", ex:"Piove, quindi resto a casa."},
  ...
  {it:"chi",        ar:"مَن",            ipa:"/ki/",                 pron:"كي",             cat:"أدوات ربط", ex:"Chi ha telefonato?"},
  {it:"quale",      ar:"أنهي",           ipa:"/ˈkwaː.le/",           pron:"كوا-لماذا",        cat:"أدوات ربط", ex:"Quale libro preferisci?"},
  {it:"quando",     ar:"متى",           ipa:"/ˈkwan.do/",           pron:"كوان-دو",        cat:"أدوات ربط", ex:"Quando arrivi a casa?"},
  {it:"quanto",     ar:"كم",         ipa:"/ˈkwan.to/",           pron:"كوان-تو",        cat:"أدوات ربط", ex:"Quanto costa questo libro?"},
  ...
  {it:"ancora",       ar:"ما زال",           ipa:"/aŋˈkoː.ra/",          pron:"أن-كو-را",        cat:"ظروف", ex:"Non ho ancora finito i compiti."},
  ...
  {it:"lentamente",   ar:"ببطء",          ipa:"/len.taˈmen.te/",      pron:"لين-تا-مَن-تيه",  cat:"ظروف", ex:"Lui parla molto lentamente."},
  {it:"velocemente",  ar:"بسرعة",         ipa:"/ve.lo.tʃeˈmen.te/",   pron:"في-لو-تشيه-مَن-تيه", cat:"ظروف", ex:"Ha finito velocemente il lavoro."},
  {it:"facilmente",   ar:"بسهولة",        ipa:"/fa.tʃilˈmen.te/",     pron:"فا-تشيل-مَن-تيه", cat:"ظروف", ex:"Capisce tutto facilmente."},
  ...
  {it:"dentro",       ar:"داخل",           ipa:"/ˈdɛn.tro/",           pron:"دين-ترو",         cat:"ظروف", ex:"Il gatto è dentro la casa."},
  ...
  {it:"destra",       ar:"يمَن",          ipa:"/ˈdɛs.tra/",           pron:"ديس-ترا",         cat:"ظروف", ex:"Gira a destra al semaforo."},
  ...
  {it:"difficile",     ar:"صعب",              ipa:"/difˈfiː.tʃi.le/",   pron:"ديفـ-في-تشي-لماذا", cat:"صفات", ex:"Questo esame è molto difficile."},
  {it:"interessante",  ar:"مثير للاهممتاز",    ipa:"/in.te.resˈsan.te/", pron:"إن-تيريسّان-تيه", cat:"صفات", ex:"Il film era molto interessante."},
  {it:"famoso",        ar:"ليسهور",            ipa:"/faˈmoː.zo/",        pron:"فا-مو-زو",       cat:"صفات", ex:"Questo ristorante è famoso a Roma."},
  ...
  {it:"esempio",      ar:"مثال",        ipa:"/eˈzɛm.pjo/",        pron:"إي-مثلم-بيو",     cat:"أشياء",      ex:"Puoi darmi un esempio?"},
  {it:"errore",       ar:"خطأة",        ipa:"/erˈroː.re/",        pron:"إيرّو-ريه",      cat:"أشياء",      ex:"Ho fatto un piccolo errore."},
  ...
  {it:"progetto",     ar:"ليسروع",       ipa:"/proˈdʒɛt.to/",      pron:"بروجيتّو",       cat:"عام",        ex:"Il progetto finisce questo mese."},
  {it:"idea",         ar:"فكرة",        ipa:"/iˈdɛː.a/",          pron:"إيديا",          cat:"عام",        ex:"Ho un'idea interessante."},
  {it:"pazienza",     ar:"صبر",         ipa:"/patˈtsjɛn.tsa/",    pron:"باتـتسيينتسا",   cat:"ليساعر",      ex:"Ci vuole molta pazienza."},
  {it:"gentilezza",   ar:"لطف",         ipa:"/dʒen.tiˈlet.tsa/",  pron:"جينتيليتّسا",    cat:"ليساعر",      ex:"Mi ha trattato con gentilezza."},
  {it:"fame",         ar:"جوع",         ipa:"/ˈfaː.me/",          pron:"فامي",           cat:"ليساعر",      ex:"Ho fame, mangiamo qualcosa?"},
  ...
  {it:"sbagliare",   ar:"يخطأ",     ipa:"/zbaʎˈʎaː.re/",     pron:"إزبالياري",     cat:"أفعال", ex:"Tutti possono sbagliare."},
  ...
  {it:"avete",     ar:"(أنتم) فعلتوا / عندكم", ipa:"/aˈveː.te/",    pron:"أفيتيه",    cat:"تصريف الفعل", ex:"Avete finito i compiti?"},
  ...
  {it:"siete",     ar:"(أنتم) كنتم",        ipa:"/ˈsjɛː.te/",      pron:"سييتيه",    cat:"تصريف الفعل", ex:"Siete tornati tardi ieri."},
  ...
  {it:"eravate",   ar:"(أنتم) كنتم",        ipa:"/e.raˈvaː.te/",   pron:"إيرافاتيه", cat:"تصريف الفعل", ex:"Eravate a scuola quel giorno."},
  {it:"erano",     ar:"(هم) كانوا",          ipa:"/ˈɛː.ra.no/",     pron:"إيرانو",    cat:"تصريف الفعل", ex:"Erano tutti stanchi ieri sera."},
];

// ===== LESSON_SENTENCES انتقلت لملفات lesson_io.js .. lesson_loro.js + lesson_manifest.js (مخطط word pipeline) =====
...
{it:"Devo andare al supermercato a comprare il pane", ar:"لازم أروح السوبر ماركت أشتري عيش", en:"I need to go to the supermarket to buy bread.",
 words:[
  ...
  {it:"supermercato",ar:"السوبر ماركت"},{it:"a",ar:"لكي"},
  {it:"comprare",ar:"أشتري"},{it:"il",ar:"الـ"},{it:"pane",ar:"العيش"}
]},

{it:"Quanto costa questo prodotto nel negozio", ar:"بكم المنتج هذا في المحل", en:"How much does this product cost in the shop?",
 words:[
  {it:"Quanto",ar:"بكم"},{it:"costa",ar:"بيكلف"},{it:"questo",ar:"الـ"},
...
// ── مواصلات ─────────────────────────────────────────────────────────
{it:"Il treno per Milano parte tra dieci minuti dal binario tre", ar:"القطار لميلانو بيليسي بعد عشر دقايق من الرصيف الثلاثة", en:"The train to Milan leaves in ten minutes from platform three.",
 words:[
  {it:"Il",ar:"الـ"},{it:"treno",ar:"القطار"},{it:"per",ar:"لـ"},
  {it:"Milano",ar:"ميلانو"},{it:"parte",ar:"بيليسي"},{it:"tra",ar:"بعد"},
  {it:"dieci",ar:"عشر"},{it:"minuti",ar:"دقايق"},{it:"dal",ar:"من الـ"},
  {it:"binario",ar:"الرصيف"},{it:"tre",ar:"الثلاثة"}
]},

{it:"Devo prendere l'autobus numero dodici per andare in centro", ar:"لازم آخد الأتوبيس رقم اتناشر لكي أروح وسط البلد", en:"I need to take bus number twelve to go to the city center.",
 words:[
  {it:"Devo",ar:"لازم"},{it:"prendere",ar:"آخد"},{it:"l'autobus",ar:"الأتوبيس"},
  {it:"numero",ar:"رقم"},{it:"dodici",ar:"اتناشر"},{it:"per",ar:"لكي"},
...
// ── مطعم ────────────────────────────────────────────────────────────
{it:"Vorrei un tavolo per due persone vicino alla finestra", ar:"تريد ترابيزة لاتنين قريب من الشباك", en:"I'd like a table for two people near the window.",
 words:[
  {it:"Vorrei",ar:"تريد"},{it:"un",ar:"(تنكير)"},{it:"tavolo",ar:"ترابيزة"},
...
{it:"Vorrei ordinare una pizza margherita e un'insalata mista", ar:"تريد أطلب بيتزا مارغريتا وسلطة ليسكلة", en:"I'd like to order a margherita pizza and a mixed salad.",
 words:[
  {it:"Vorrei",ar:"تريد"},{it:"ordinare",ar:"أطلب"},{it:"una",ar:"(تنكير)"},
  {it:"pizza",ar:"بيتزا"},{it:"margherita",ar:"مارغريتا"},{it:"e",ar:"و"},
  {it:"un'insalata",ar:"سلطة"},{it:"mista",ar:"ليسكلة"}
]},

// ── صحيحة / صيدلية ────────────────────────────────────────────────────
{it:"Non mi sento bene, ho mal di testa da ieri sera", ar:"ليس بحس بخير عندي صداع من امبارح بالذيل", en:"I don't feel well, I've had a headache since last night.",
 words:[
  {it:"Non",ar:"ليس"},{it:"mi",ar:"أنا"},{it:"sento",ar:"بحس"},
  {it:"bene",ar:"بخير"},{it:"ho",ar:"عندي"},{it:"mal",ar:"ألم"},
  {it:"di",ar:"في الـ"},{it:"testa",ar:"دماغ"},{it:"da",ar:"من"},
  {it:"ieri",ar:"امبارح"},{it:"sera",ar:"بالذيل"}
]},
...
{it:"Devo finire questo progetto entro venerdì prossimo", ar:"لازم أخلص الليسروع هذا قبل الجمعة الجاية", en:"I need to finish this project by next Friday.",
 words:[
  {it:"Devo",ar:"لازم"},{it:"finire",ar:"أخلص"},{it:"questo",ar:"الـ"},
  {it:"progetto",ar:"الليسروع"},{it:"entro",ar:"قبل"},{it:"venerdì",ar:"الجمعة"},
...
// ── بيت / يوميات ────────────────────────────────────────────────────
{it:"Stasera cucino la pasta con il sugo di pomodoro", ar:"الذيلة بطبخ باستا بصوص الطماطم", en:"Tonight I'm cooking pasta with tomato sauce.",
 words:[
  {it:"Stasera",ar:"الذيلة"},{it:"cucino",ar:"بطبخ"},{it:"la",ar:"الـ"},
  {it:"pasta",ar:"الباستا"},{it:"con",ar:"بـ"},{it:"il",ar:"الـ"},
  {it:"sugo",ar:"صوص"},{it:"di",ar:"بـ"},{it:"pomodoro",ar:"طماطم"}
]},

{it:"Devo fare la spesa e poi portare i bambini a scuola", ar:"لازم أعمل الليستريات وبعدين أوصّل الأطفال للمدرسة", en:"I need to do the shopping and then take the kids to school.",
 words:[
  {it:"Devo",ar:"لازم"},{it:"fare",ar:"أعمل"},{it:"la",ar:"الـ"},
  {it:"spesa",ar:"الليستريات"},{it:"e",ar:"و"},{it:"poi",ar:"بعدين"},
  {it:"portare",ar:"أوصّل"},{it:"i",ar:"الـ"},{it:"bambini",ar:"الأطفال"},
  {it:"a",ar:"لـ"},{it:"scuola",ar:"المدرسة"}
]},

{it:"L'affitto di questo appartamento è troppo caro per me", ar:"إيجار الشقة هذه غالي أوي عليا", en:"The rent for this apartment is too expensive for me.",
 words:[
...
// ── طقس ───────────────────────────────────────────────────────────────
{it:"Oggi fa molto caldo, ma domani arriva un po' di pioggia", ar:"النهارده حر جداً بس بكره هتيجي قليل مطر", en:"Today it's very hot but tomorrow some rain is coming.",
 words:[
  {it:"Oggi",ar:"النهارده"},{it:"fa",ar:"في"},{it:"molto",ar:"جداً"},
  {it:"caldo",ar:"حر"},{it:"ma",ar:"بس"},{it:"domani",ar:"بكره"},
  {it:"arriva",ar:"هتيجي"},{it:"un",ar:"(تنكير)"},{it:"po'",ar:"قليل"},
...
// ── تليفون / تواصل ──────────────────────────────────────────────────
{it:"Ti chiamo dopo cena per parlare di questa cosa importante", ar:"سأتصل بك بعد العشا لكي نتكلم في الموضوع المهم هذا", en:"I'll call you after dinner to talk about this important thing.",
 words:[
  {it:"Ti",ar:"سأتصل بك"},{it:"chiamo",ar:"أتصل"},{it:"dopo",ar:"بعد"},
  {it:"cena",ar:"العشا"},{it:"per",ar:"لكي"},{it:"parlare",ar:"نتكلم"},
  {it:"di",ar:"في"},{it:"questa",ar:"الـ"},{it:"cosa",ar:"الموضوع"},
  {it:"importante",ar:"المهم"}
]},

{it:"Ho ricevuto un messaggio da Marco, ma non ho ancora risposto", ar:"استلمت رسالة من ماركو بس ما رديتش ما زال", en:"I received a message from Marco but haven't replied yet.",
 words:[
  ...
  {it:"ancora",ar:"ما زال"},{it:"risposto",ar:"ردّيت"}
]},

// ── ترفيه / أوقات فراغ ──────────────────────────────────────────────
{it:"Questo fine settimana andiamo al cinema con gli amici", ar:"الويك إند هذا هنروح السينما مع الأصحيحاب", en:"This weekend we're going to the cinema with friends.",
 words:[
  {it:"Questo",ar:"الـ"},{it:"fine",ar:"نهاية"},{it:"settimana",ar:"الأسبوع"},
  {it:"andiamo",ar:"هنروح"},{it:"al",ar:"للـ"},{it:"cinema",ar:"السينما"},
  {it:"con",ar:"مع"},{it:"gli",ar:"الـ"},{it:"amici",ar:"الأصحيحاب"}
]},

{it:"Mi piace molto ascoltare la musica, mentre cucino la sera", ar:"بحب أوي أسمع موسيقى وأنا بطبخ بالذيل", en:"I really like listening to music while I cook in the evening.",
 words:[
...
{it:"Quanta pasta vuoi per cena?", ar:"تريد مكرونة قد ما للعشا؟", en:"How much pasta do you want for dinner?",
 words:[
  {it:"Quanta",ar:"قد ما (مؤنث)",note:"صفة استفهامية للكمية، مؤنث مفرد"},{it:"pasta",ar:"مكرونة"},
  {it:"vuoi",ar:"تريد"},{it:"per",ar:"لـ"},{it:"cena",ar:"العشا"}
]},

{it:"Quanti fratelli e quante sorelle hai?", ar:"عندك كم أخ وكم أخت؟", en:"How many brothers and how many sisters do you have?",
 words:[
  {it:"Quanti",ar:"كم (جمع مذكر)",note:"صفة استفهامية للكمية، جمع مذكر"},{it:"fratelli",ar:"إخوة"},
  {it:"e",ar:"و"},{it:"quante",ar:"كم (جمع مؤنث)",note:"صفة استفهامية للكمية، جمع مؤنث"},
  {it:"sorelle",ar:"أخوات"},{it:"hai",ar:"عندك"}
]},

{it:"Quali film preferisci guardare?", ar:"انهي أفلام بتفضل تتفرج علماذاا؟", en:"Which movies do you prefer to watch?",
 words:[
...
{it:"I miei genitori e le mie sorelle abitano a Roma", ar:"والديّ وأخواتي بيسكنوا في روما", en:"My parents and my sisters live in Rome.",
 words:[
  {it:"I",ar:"الـ"},{it:"miei",ar:"الخاصة بي (جمع مذكر)",note:"صفة ملكية، جمع مذكر لـ mio"},
  {it:"genitori",ar:"والدين"},{it:"e",ar:"و"},{it:"le",ar:"الـ"},
  {it:"mie",ar:"الخاصة بي (جمع مؤنث)",note:"صفة ملكية، جمع مؤنث لـ mia"},
...
{it:"I tuoi consigli e le tue idee mi hanno aiutato molto", ar:"نصايحك وأفكارك ساعدوني كتير", en:"Your advice and your ideas helped me a lot.",
 words:[
  {it:"I",ar:"الـ"},{it:"tuoi",ar:"الخاصة بك (جمع مذكر)",note:"صفة ملكية، جمع مذكر لـ tuo"},
  {it:"consigli",ar:"نصايح"},{it:"e",ar:"و"},{it:"le",ar:"الـ"},
  {it:"tue",ar:"الخاصة بك (جمع مؤنث)",note:"صفة ملكية، جمع مؤنث لـ tua"},
...
{it:"Sua madre e i suoi fratelli sono venuti, ma le sue sorelle no", ar:"أمه وأخواته الذكور جم، بس أخواته البنات لأ", en:"His mother and his brothers came, but his sisters did not.",
 words:[
  ...
  {it:"suoi",ar:"الخاصة به/الخاصة بها (جمع مذكر)",note:"صفة ملكية، جمع مذكر لـ suo"},
  ...
  {it:"sue",ar:"الخاصة به/الخاصة بها (جمع مؤنث)",note:"صفة ملكية، جمع مؤنث لـ suo"},
...
{it:"Il nostro professore ha detto che i nostri esami e le nostre lezioni cambieranno", ar:"أستاذنا قال إن امتحاناتنا ودروسنا هتتغير", en:"Our teacher said that our exams and our lessons will change.",
 words:[
  ...
  {it:"nostri",ar:"الخاصة بنا (جمع مذكر)",note:"صفة ملكية، جمع مذكر"},{it:"esami",ar:"امتحانات"},
  {it:"e",ar:"و"},{it:"le",ar:"الـ"},
  {it:"nostre",ar:"الخاصة بنا (جمع مؤنث)",note:"صفة ملكية، جمع مؤنث"},{it:"lezioni",ar:"دروس"},
  {it:"cambieranno",ar:"هتتغير"}
]},

{it:"La vostra pazienza e le vostre idee sono importanti per noi", ar:"صبركم وأفكاركم مهمَن لينا", en:"Your patience and your ideas are important to us.",
 words:[
  {it:"La",ar:"الـ"},{it:"vostra",ar:"الخاصة بكم (مفرد مؤنث)",note:"صفة ملكية، مفرد مؤنث"},
  {it:"pazienza",ar:"صبر"},{it:"e",ar:"و"},{it:"le",ar:"الـ"},
  {it:"vostre",ar:"الخاصة بكم (جمع مؤنث)",note:"صفة ملكية، جمع مؤنث"},{it:"idee",ar:"أفكار"},
  {it:"sono",ar:""},{it:"importanti",ar:"مهمَن"},{it:"per",ar:"لـ"},{it:"noi",ar:"إحنا"}
]},
...
{it:"Ho comprato dei libri e degli zaini per i bambini", ar:"شريت كتب وشنط ظهر للأطفال", en:"I bought some books and some backpacks for the children.",
 words:[
  ...
  {it:"dei",ar:"بعض (جمع مذكر)",note:"أداة تجمثلئية جمع مذكر"},{it:"libri",ar:"كتب"},
  {it:"e",ar:"و"},{it:"degli",ar:"بعض (جمع مذكر يبدأ بحرف متحرك)",note:"أداة تجمثلئية جمع مذكر قبل صوت متحرك"},
  {it:"zaini",ar:"شنط ظهر"},{it:"per",ar:"لـ"},{it:"i",ar:"الـ"},{it:"bambini",ar:"الأطفال"}
]},

{it:"Ho bisogno delle chiavi e dello zucchero per la torta", ar:"محتاج المفاتيح وقليل سكر للتورتة", en:"I need the keys and some sugar for the cake.",
 words:[
  {it:"Ho",ar:"عندي"},{it:"bisogno",ar:"محتاج"},
  {it:"delle",ar:"بعض (جمع مؤنث)",note:"أداة تجمثلئية جمع مؤنث"},{it:"chiavi",ar:"مفاتيح"},
  {it:"e",ar:"و"},{it:"dello",ar:"بعض (مفرد مذكر يبدأ بـ s+consonante أو z)",note:"أداة تجمثلئية مفرد مذكر خاصة"},
  {it:"zucchero",ar:"سكر"},{it:"per",ar:"لـ"},{it:"la",ar:"الـ"},{it:"torta",ar:"تورتة"}
]},

{it:"Questi ragazzi e queste ragazze studiano insieme ogni giorno", ar:"الشباب هؤلاء والبنات هؤلاء بيدرسوا مع بعض كل يوم", en:"These boys and these girls study together every day.",
 words:[
  {it:"Questi",ar:"هؤلاء (جمع مذكر)",note:"ضمير/صفة إشارية جمع مذكر لـ questo"},{it:"ragazzi",ar:"شباب"},
  {it:"e",ar:"و"},{it:"queste",ar:"هؤلاء (جمع مؤنث)",note:"ضمير/صفة إشارية جمع مؤنث لـ questa"},
  {it:"ragazze",ar:"بنات"},{it:"studiano",ar:"بيدرسوا"},{it:"insieme",ar:"مع بعض"},
  {it:"ogni",ar:"كل"},{it:"giorno",ar:"يوم"}
]},

{it:"Quello zaino è pesante, ma quella borsa è leggera", ar:"الشنطة داك ثقيلة، بس الشنطة الجزدان هذه خفيفة", en:"That backpack is heavy, but that bag is light.",
 words:[
  {it:"Quello",ar:"داك (مفرد مذكر)",note:"صفة إشارية مفرد مذكر"},{it:"zaino",ar:"شنطة ظهر"},
  {it:"è",ar:""},{it:"pesante",ar:"ثقيلة"},{it:"ma",ar:"بس"},
  {it:"quella",ar:"هذه (مفرد مؤنث)",note:"صفة إشارية مفرد مؤنث"},{it:"borsa",ar:"شنطة/جزدان"},
...
{it:"Quegli studenti e quelle studentesse hanno superato l'esame", ar:"الطلبة داك والطالبات داك نجحوا في الامتحان", en:"Those students (male) and those students (female) passed the exam.",
 words:[
  ...
  {it:"quelle",ar:"هؤلاء (جمع مؤنث)",note:"صفة إشارية جمع مؤنث"},{it:"studentesse",ar:"طالبات"},
...
{it:"Quei bambini giocavano mentre quelli più grandi studiavano", ar:"الأطفال داك كانوا بيلعبوا وداك الأكبر كانوا بيذاكروا", en:"Those children were playing while those older ones were studying.",
 words:[
  ...
  {it:"quelli",ar:"داك (ضمير، جمع مذكر)",note:"ضمير إشاري جمع مذكر، ليس صفة"},
...
{it:"Ognuno ha la sua opinione, e non voglio dire nulla o niente di più", ar:"كل واحد له رأيه، وليس تريد اقول ولا شيء مرة أخرىة", en:"Everyone has their own opinion, and I don't want to say anything more.",
 words:[
  {it:"Ognuno",ar:"كل واحد",note:"ضمير غير محدد، مفرد"},{it:"ha",ar:"له"},{it:"la",ar:"الـ"},
  {it:"sua",ar:"بتاعه"},{it:"opinione",ar:"رأي"},{it:"e",ar:"و"},{it:"non",ar:"ليس"},
  {it:"voglio",ar:"تريد"},{it:"dire",ar:"اقول"},
  {it:"nulla",ar:"ولا شيء",note:"ضمير غير محدد للنفي، مثل niente"},{it:"o",ar:"أو"},
  {it:"niente",ar:"ولا شيء",note:"ضمير غير محدد للنفي، مثل nulla"},{it:"di più",ar:"أكتر"}
]},
...
{it:"Non conosco nessuno qui, non ne conosco alcuno", ar:"ليس عارف حد هنا، ليس عارف ولا حد فيهم", en:"I don't know anyone here, I don't know any of them.",
 words:[
  {it:"Non",ar:"ليس"},{it:"conosco",ar:"عارف"},{it:"nessuno",ar:"حد"},{it:"qui",ar:"هنا"},
  {it:"non",ar:"ليس"},{it:"ne",ar:"منهم"},{it:"conosco",ar:"عارف"},
  {it:"alcuno",ar:"ولا حد (فيهم)",note:"ضمير غير محدد، نادر الاستخدام كصفة، بيتقال غالبًا كضمير بعد ne في النفي"}
]},

{it:"Non ho alcuna intenzione di andare a quella festa", ar:"معنديش أي نية إني اروح الحفلة هذه", en:"I have no intention of going to that party.",
 words:[
  {it:"Non",ar:"ليس"},{it:"ho",ar:"عندي"},
  {it:"alcuna",ar:"أي (مؤنث)",note:"صفة غير محددة، مؤنث، تُستخدم غالبًا في النفي"},
  {it:"intenzione",ar:"نية"},{it:"di",ar:"إني"},{it:"andare",ar:"اروح"},{it:"a",ar:"لـ"},
  {it:"quella",ar:"هذه"},{it:"festa",ar:"حفلة"}
]},

{it:"Alcuni amici e alcune amiche mi hanno scritto ieri", ar:"بعض الأصحيحاب وبعض الصاحبات كتبولي إمبارح", en:"Some friends (male and female) wrote to me yesterday.",
 words:[
  {it:"Alcuni",ar:"بعض (جمع مذكر)",note:"صفة/ضمير غير محدد جمع مذكر"},{it:"amici",ar:"أصحيحاب"},
...
{it:"C'è troppa gente, troppi rumori e troppe macchine in questa città", ar:"فيه ناس كتير أوي، وضوضا كتير أوي، وعربيات كتير أوي في المدينة هذه", en:"There is too much people, too many noises, and too many cars in this city.",
 words:[
  ...
  {it:"in",ar:"في"},{it:"questa",ar:"هذه"},{it:"città",ar:"مدينة"}
]},

{it:"Ho tanto lavoro, tanta fame, tanti amici e tante idee", ar:"عندي شغل كتير جدًا، وجعان جدًا، وأصحيحاب كتير جدًا، وأفكار كتير جدًا", en:"I have so much work, so much hunger, so many friends, and so many ideas.",
 words:[
  ...
  {it:"tanti",ar:"كتير جدًا (جمع مذكر)",note:"جمع مذكر لـ tanto"},{it:"amici",ar:"أصحيحاب"},
  {it:"e",ar:"و"},{it:"tante",ar:"كتير جدًا (جمع مؤنث)",note:"جمع مؤنث لـ tanto"},{it:"idee",ar:"أفكار"}
]},

{it:"Ho aspettato parecchio tempo con parecchia pazienza, insieme a parecchi amici e parecche amiche", ar:"استنيت وقت كتير بصبر جيد، مع أصحيحاب كتير وصاحبات كتير", en:"I waited quite a long time with quite a lot of patience, together with quite a few friends.",
 words:[
  ...
  {it:"insieme a",ar:"مع"},{it:"parecchi",ar:"كتير نسبيًا (جمع مذكر)",note:"جمع مذكر لـ parecchio"},{it:"amici",ar:"أصحيحاب"},
  {it:"e",ar:"و"},{it:"parecche",ar:"كتير نسبيًا (جمع مؤنث)",note:"جمع مؤنث لـ parecchio"},{it:"amiche",ar:"صاحبات"}
]},

{it:"Vuoi un altro caffè o un'altra bibita? Ho anche altri dolci e altre bevande", ar:"تريد قهوة مرة أخرىة ولا ليسروب مرة أخرى؟ عندي أيضًا حلويات مرة أخرىة وليسروبات مرة أخرىة", en:"Do you want another coffee or another drink? I also have other sweets and other drinks.",
 words:[
  {it:"Vuoi",ar:"تريد"},{it:"un",ar:""},{it:"altro",ar:"مرة أخرى (مفرد مذكر)",note:"صفة/ضمير غير محدد، مفرد مذكر"},
  {it:"caffè",ar:"قهوة"},{it:"o",ar:"ولا"},{it:"un'altra",ar:"مرة أخرىة (مفرد مؤنث)",note:"altra، مفرد مؤنث لـ altro"},
  {it:"bibita",ar:"ليسروب"},{it:"Ho",ar:"عندي"},{it:"anche",ar:"أيضًا",note:"ظرف بمعنى also/too"},
  {it:"altri",ar:"مرة أخرىة (جمع مذكر)",note:"جمع مذكر لـ altro"},{it:"dolci",ar:"حلويات"},
  {it:"e",ar:"و"},{it:"altre",ar:"مرة أخرىة (جمع مؤنث)",note:"جمع مؤنث لـ altro"},{it:"bevande",ar:"ليسروبات"}
]},

{it:"Certo che vengo! Certa gente non capisce che certi giorni sono difficili per certe persone", ar:"بالطبع هاجي! في ناس ما بيفهموش إن في أيام صعبة على ناس معينة", en:"Of course I'm coming! Certain people don't understand that certain days are hard for certain people.",
 words:[
  {it:"Certo",ar:"بالطبع",note:"هنا بمعنى بالتأكيد؛ ولما تيجي قبل اسم بتبقى صفة غير محددة"},{it:"che",ar:"إن"},
  {it:"vengo",ar:"هاجي"},{it:"Certa",ar:"معينة (مفرد مؤنث)",note:"صفة غير محددة، مفرد مؤنث"},
  {it:"gente",ar:"ناس"},{it:"non",ar:"ليس"},{it:"capisce",ar:"تفهم"},{it:"che",ar:"إن"},
...
{it:"Non so dove hai messo le chiavi", ar:"ليس عارف حطيت المفاتيح فين", en:"I don't know where you put the keys.",
 words:[
  {it:"Non",ar:"ليس"},{it:"so",ar:"عارف"},{it:"dove",ar:"فين",note:"حرف جر/ظرف استفهامي أو رابط للمكان"},
  {it:"hai",ar:"",note:"جزء من الفعل المساعد"},{it:"messo",ar:"حطيت",note:"Mettere، Passato Prossimo"},
  {it:"le",ar:"الـ"},{it:"chiavi",ar:"مفاتيح"}
]},

{it:"Abbiamo camminato lungo la spiaggia mentre parlavamo", ar:"ليسينا على طول الشط وإحنا بنتكلم", en:"We walked along the beach while we were talking.",
 words:[
  {it:"Abbiamo",ar:"",note:"جزء من الفعل المساعد"},{it:"camminato",ar:"ليسينا",note:"Camminare، Passato Prossimo"},
...
{it:"Sono uscito verso le nove di sera", ar:"خرجت حوالي الساعة تسعة بالذيل", en:"I went out around nine in the evening.",
 words:[
...
{it:"Secondo me, hai fatto la scelta giusta", ar:"حسب رأيي، اخترت الاختيار الصحيحيح", en:"In my opinion, you made the right choice.",
 words:[
  ...
  {it:"la",ar:"الـ"},{it:"scelta",ar:"اختيار"},{it:"giusta",ar:"صحيحيح"}
]},

{it:"Oltre al lavoro, ho anche altri impegni", ar:"غير الشغل، عندي التزامات مرة أخرىة أيضًا", en:"Besides work, I also have other commitments.",
 words:[
  {it:"Oltre",ar:"غير",note:"حرف جر مركب بمعنى besides/beyond"},{it:"al",ar:"الـ"},{it:"lavoro",ar:"شغل"},
  {it:"ho",ar:"عندي"},{it:"anche",ar:"أيضًا",note:"ظرف بمعنى also/too"},{it:"altri",ar:"مرة أخرىة"},{it:"impegni",ar:"التزامات"}
]},

{it:"Hanno mangiato tutto eccetto la verdura", ar:"أكلوا كل شيء غير الخضار", en:"They ate everything except the vegetables.",
 words:[
  {it:"Hanno",ar:"",note:"جزء من الفعل المساعد"},{it:"mangiato",ar:"أكلوا",note:"Mangiare، Passato Prossimo"},
  {it:"tutto",ar:"كل شيء"},{it:"eccetto",ar:"غير",note:"حرف جر مركب بمعنى except"},{it:"la",ar:"الـ"},{it:"verdura",ar:"خضار"}
]},

{it:"Andremo alla festa, salvo imprevisti", ar:"هنروح للحفلة، إلا لو حصل شيء غير متوقعة", en:"We'll go to the party, unless something unexpected happens.",
 words:[
  {it:"Andremo",ar:"هنروح"},{it:"alla",ar:"للـ"},{it:"festa",ar:"حفلة"},
  {it:"salvo",ar:"إلا لو",note:"حرف جر مركب بمعنى except/barring"},{it:"imprevisti",ar:"شيء غير متوقعة"}
]},
...
{it:"Vengo anche io alla festa, vieni pure tu!", ar:"هاجي أنا أيضًا للحفلة، تعالى أنت أيضًا!", en:"I'm coming to the party too, you come too!",
 words:[
  {it:"Vengo",ar:"هاجي"},{it:"anche",ar:"أيضًا",note:"ظرف بمعنى also/too، ممكن تتحول لـ anch' قبل io"},
  {it:"io",ar:"أنا"},{it:"alla",ar:"للـ"},{it:"festa",ar:"حفلة"},
  {it:"vieni",ar:"تعالى"},{it:"pure",ar:"أيضًا",note:"ظرف بمعنى also/too، وأيضًا بيستخدم كتشجيع مثل Vai pure!"},{it:"tu",ar:"أنت"}
]},
